class Pagination2 {
    constructor(options) {
        ...
        this.nextButton = this.element.getElementsByClassName('next2')[0];
        this.prevButton = this.element.getElementsByClassName('previous2')[0];
        this.paginationLabel = this.element.getElementsByClassName('pagination-label2')[0];
